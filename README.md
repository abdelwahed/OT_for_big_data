...
* **2017** - __`ICCV`__ [*Open set domain adaptation*](http://openaccess.thecvf.com/content_iccv_2017/html/Busto_Open_Set_Domain_ICCV_2017_paper.html)  <img src="/imgs/github-mark.png" width="20" height="20" /> [<font color="pink"> Code</font>](https://github.com/iCGY96/awesome_OpenSetRecognition_list.git)
...
* **2014** - __`NeurIPS`__ [*Generative adversarial nets*](https://proceedings.neurips.cc/paper/5423-generative-adversarial-nets)  <img src="/imgs/github-mark.png" width="20" height="20" /> [<font color="pink"> Code</font>](https://github.com/zhangqianhui/AdversarialNetsPapers.git)
...
* **1977** -  [*Applied Mathematical Programming*](http://web.mit.edu/15.053/www/AMP.htm)  <img src="/imgs/github-mark.png" width="20" height="20" /> [<font color="pink"> Code</font>](https://github.com/deeplearningIndia1001/Post-07.git)
* **1991** -  [*The Minimum Cost Flow Problem and The Network Simplex Solution Method*](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.96.6462&rep=rep1&type=pdf) 
